...
class UsersWP_Seo {
	...
	public function __construct(){
		...
		add_action ( 'plugins_loaded', array( $this, 'run_once_all_plugins_loaded' ) );
	...
	function run_once_all_plugins_loaded() {
		if( UsersWP_Seo::has_yoast() ) {
			add_filter( 'wpseo_canonical', array( $this, 'filter_yoast_profile_page_canonical' ) );
		}
	}
	/**
	 ...
	 */
	function filter_yoast_profile_page_canonical( $canonical ) {
