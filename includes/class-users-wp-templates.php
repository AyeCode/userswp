...
class Users_WP_Templates {
    ...
    public function uwp_theme_compat_styles() {
        if ( is_uwp_page() ) {
            $theme_obj = wp_get_theme();
            $theme = $theme_obj->name;
            ob_start();
            if ($theme == 'Twenty Thirteen') {
                ?>
                <style type="text/css">
                    .uwp_form input.uwp-half {
                        width: 39.2% !important;
                    }
                    .uwp_form input[type="file"] {
                        width: 90% !important;
            ...
            if ($theme == 'Twenty Fourteen') {
                ...
                <style type="text/css">
                    ...
                    .uwp-user-search input[type="text"] {
                        font-size: 11px;
                    }
                    .uwp-user-sort #uwp_sort_by {
                        height: 31px;
                    }
                </style>
                <?php
            }
            if ($theme == 'Twenty Fifteen') {
                ?>
                <style type="text/css">
                    .uwp_form input[type="file"] {
                        padding: 12px 15px !important;
                    ...
                    .uwp-user-search .uwp-search-submit {
            ...
            if ($theme == 'GeoDirectory Framework') {
                ?>
                <style type="text/css">
                    ...
                    .uwp-profile-extra-table tr:nth-child(odd) {
