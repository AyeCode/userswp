...
if ( ! class_exists( 'WP_Bootstrap_Settings' ) ) {
	...
	class WP_Bootstrap_Settings {
		...
		public function enqueue_style() {
			...
			if($this->settings['css']){
				$url = $this->settings['css']=='core' ? $this->url.'assets/css/bootstrap-ui.css' : $this->url.'assets/css/bootstrap-ui-compatibility.css';
				wp_register_style( 'bootstrap-ui', $url, array(), $this->latest );
                ...
                ";
					wp_add_inline_style( 'bootstrap-ui', $custom_css );
				}
						...
						<tr valign="top">
							...
							<td>
								<select name="wp-bootstrap-settings[css]" id="wpbs-css">
									<option	value="compatibility" <?php selected( $this->settings['css'], 'compatibility' ); ?>><?php _e( 'Compatibility Mode', 'bootstrap-settings' ); ?></option>
									<option value="core" <?php selected( $this->settings['css'], 'core' ); ?>><?php _e( 'Full Mode', 'bootstrap-settings' ); ?></option>
						...
						<tr valign="top">
							...
							<td>
								<select name="wp-bootstrap-settings[js]" id="wpbs-js">
									<option	value="core-popper" <?php selected( $this->settings['js'], 'core-popper' ); ?>><?php _e( 'Core + Popper (default)', 'bootstrap-settings' ); ?></option>
