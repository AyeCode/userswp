<?php do_action('uwp_template_before', 'login'); ?>
    <div class="uwp-content-wrap">
        <div class="uwp-login" <?php if(!empty($uwp_login_widget_args['form_padding'])){echo "style='padding:".absint($uwp_login_widget_args['form_padding'])."px'";}?>>
            ...
            <h2><?php
                $form_title = ! empty( $uwp_widget_args['form_title'] ) || ( isset($uwp_widget_args['form_title']) && $uwp_widget_args['form_title']=='0' ) ? esc_attr__( $uwp_widget_args['form_title'], 'userswp' ) : __( 'Login', 'userswp' );
