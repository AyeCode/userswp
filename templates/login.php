    ...
    <div class="uwp-content-wrap">
        <div class="uwp-login" <?php if(!empty($uwp_login_widget_args['form_padding'])){echo "style='padding:".absint($uwp_login_widget_args['form_padding'])."px'";}?>>
            ...
            <h2><?php
                ...
                echo apply_filters('uwp_template_form_title',  $form_title, 'login'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                ?></h2>
            ...
            <div class="uwp-login-links">
                ...
                <div class="uwp-footer-link uwp-forgotpsw"><a rel="nofollow" href="<?php echo esc_url( uwp_get_forgot_page_url() ); ?>"><?php echo uwp_get_option("forgot_link_title") ? esc_html( uwp_get_option("forgot_link_title") ) : esc_html__( 'Forgot password?', 'userswp' ); ?></a></div>
            </div>
