<?php do_action('uwp_template_before', 'change'); ?>
    <div class="uwp-content-wrap">
        <div class="uwp-login">
            ...
            <div class="uwp-footer-link uwp-changepsw"><a rel="nofollow" href="<?php echo uwp_get_page_link('account'); ?>"><?php echo uwp_get_option("account_link_title",__( 'Account', 'userswp' )); ?></a> <a style="float: right" href="<?php echo uwp_get_page_link('profile'); ?>"><?php echo uwp_get_option("profile_link_title",__( 'Profile', 'userswp' )); ?></a></div>
        </div>
    </div>
