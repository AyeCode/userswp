...
<div class="card text-center border-0">
    ...
    <img src="<?php echo get_avatar_url( get_current_user_id(), array('size' => 100) ); ?>" class="rounded-circle shadow border border-white border-width-4" alt="<?php echo esc_attr($user_info->data->display_name);?>">
    </a>
    <div class="card-body">
