...
<div class="uwp-content-wrap">
    <div class="uwp-login">
        ...
        <div class="uwp-footer-link uwp-forgotpsw"><?php _e( 'Already a member?', 'userswp' ); ?> <a rel="nofollow" href="<?php echo uwp_get_login_page_url(); ?>"><?php echo __( 'Login here', 'userswp' ); ?></a></div>
        <div class="clfx"></div>
        <div class="uwp-footer-link uwp-register-now"><?php _e( 'Not a member?', 'userswp' ); ?> <a rel="nofollow" href="<?php echo uwp_get_register_page_url(); ?>"><?php echo __( 'Create account', 'userswp' ); ?></a></div>
    </div>
</div>
