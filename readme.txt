...
= 1.2.71 - 2026-08-17 =
* Arbitrary File Deletion via upload_file_remove() AJAX handler - FIXED/SECURITY
...
* Enhanced validation for file field deletion - FIXED/SECURITY
...
* Editor level user in some cases may be able to remove another users profile avatar image - FIXED/SECURITY
...
* Possible authenticated file traversal leading to deleted file - FIXED/SECURITY
...
* AyeCode UI updated to v0.1.58 - CHANGED
...
* AyeCode UI updated to v0.1.50 - CHANGED
...
* Super Duper updated to v1.0.24 - CHANGED
...
* Authorbox should be center aligned in responsive - FIXED
