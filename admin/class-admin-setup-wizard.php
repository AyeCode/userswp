...
class UsersWP_Admin_Setup_Wizard {
    ...
    public function setup_introduction() {
        ?>
        <h2><?php esc_html_e( 'Welcome to the world of UsersWP!', 'userswp' ); ?></h2>
        <h4><?php _e('Flexible, Lightweight and Fast','userswp'); ?></h4>
        <p><?php _e('UsersWP allows you to add a customizable register and login form to your website. It also adds an extended profile page that override the default author page. UsersWP has been built to be lightweight and fast','userswp'); ?></p>
        <h4><?php _e('Less options, more hooks','userswp'); ?></h4>
        <p><?php _e('We cut down the options to the bare minimum and you will not find any fancy styling options in this plugin as we believe they belong in your theme. This doesn\'t mean that you cannot customize the plugin behaviour. To do this we provided a long list of Filters and Actions for any developer to extend UsersWP to fit their needs.','userswp'); ?></p>
        <h4><?php _e('Override Templates','userswp'); ?></h4>
        <p><?php echo sprintf(__('If you need to change the look and feel of any UsersWP templates, simply create a folder named userswp inside your active child theme and copy the template you wish to modify in it. You can now modify the template. The plugin will use your modified version and you don\'t have to worry about plugin or theme updates. %sClick here for examples%s','userswp'),'<a target="_blank"  href="https://userswp.io/docs/override-templates/">','</a>'); ?></p>
        <h4><?php _e('Add-Ons','userswp'); ?></h4>
        <p><?php echo sprintf(__('We have a long list of free and premium add-ons that will help you extend users management on your website. %sClick here for our official free and premium add-ons%s','userswp'),'<a target="_blank"  href="https://userswp.io/downloads/category/addons/">','</a>'); ?></p>
